...
Keychain.prototype.setOldForKey = function(successCallback, failureCallback, key, servicename, value)
{
	exec(successCallback, failureCallback, this.serviceName, "setForKey", [key, servicename, value]);
}

Keychain.prototype.removeOldForKey = function(successCallback, failureCallback, key, servicename)
{
	exec(successCallback, failureCallback, this.serviceName, "removeForKey", [key, servicename]);
}

module.exports = OldKeychain;
